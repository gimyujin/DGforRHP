...
def parse_args():
    ...
    p.add_argument("--algo", type=str, required=True, choices=["baseline", "mldg", "erm"])
...
def main():
    ...
    # NOTE:
    # eval_unseen.py 는 src/common/에 두고,
    # 실행은 프로젝트 루트에서: python src/common/eval_unseen.py ...
    ...
    print(f"[{args.algo}/{dname}] n={rep['n']:,} acc={rep['acc']:.4f} f1_macro={rep['f1_macro']:.4f}")
